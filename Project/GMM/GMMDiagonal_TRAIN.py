...
if __name__ == "__main__":
    ...
    #
    #
    #     score.append(GMMDiagonal_train_with_K_fold(DTROriginalNormalized, LTR,iteration,"GmmDiagonal_Zscore"))
    #     print("========================================================")
    #     print("========================================================")
    #     print("========================================================")
    # for iteration in range(7):
    ...
    #     print("Training for GMM Model with " + str(2 ** iteration) + " components for all pre process in report...")
    #
    #     score.append(GMMDiagonal_train_with_K_fold(DTROriginal, LTR, iteration, "GmmDiagonal"))
    #     print("========================================================")
    #     print("========================================================")
    #     print("========================================================")
    for subDimensionPCA in range(8, DTROriginal.shape[0]+1):
        ...
        for iteration in range(7):
            ...
            string="GmmDiagonalPCA"+str(subDimensionPCA)
