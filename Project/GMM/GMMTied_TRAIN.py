...
if __name__ == "__main__":
    ...
    #
    #
    #     score.append(GMMTied_train_with_K_fold(DTROriginalNormalized, LTR,iteration,"GmmTied_Zscore"))
    #     print("========================================================")
    #     print("========================================================")
    #     print("========================================================")
    # for iteration in range(7):
    ...
    #
    #
    #     score.append(GMMTied_train_with_K_fold(DTROriginal, LTR,iteration,"GmmTied"))
    #     print("========================================================")
    #     print("========================================================")
    #     print("========================================================")
    for subDimensionPCA in range(8, DTROriginal.shape[0]+1):
        ...
        for iteration in range(7):
            ...
            string="GmmTiedPCA"+str(subDimensionPCA)
