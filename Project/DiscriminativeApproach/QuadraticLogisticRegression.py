...
if __name__ == "__main__":
    ...
    dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, L, numFold, classPriorProbabilities1, costs, lambdValues)

    dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, L, numFold, classPriorProbabilities2, costs, lambdValues)

    dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, L, numFold, classPriorProbabilities3, costs, lambdValues)
    ...
    dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginal, L, numFold, classPriorProbabilities1, costs, lambdValues)

    dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginal, L, numFold, classPriorProbabilities2, costs, lambdValues)

    dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginal, L, numFold, classPriorProbabilities3, costs, lambdValues)
