...
if __name__ == "__main__":
    ...
    dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
                                             applicationWorkingPoint1, costs, lambdValues)

    dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
                                             applicationWorkingPoint2, costs, lambdValues)

    dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
    ...
    plt.legend()
    plt.savefig("./figures/QLR_Zscore_Pt0_1__DCFxLambda")
    plt.clf()
    ...
    with open("./dati/datiQLR_Zscore_Pt0_1.txt", "w") as fp:
        fp.write("dict1 :")
        fp.write(str(dict1))
        fp.write('\n')
    ...
    dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                                 applicationWorkingPoint1, costs, lambdValues)

    dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                                 applicationWorkingPoint2, costs, lambdValues)

    dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                                 applicationWorkingPoint3, costs, lambdValues)
    ...
    plt.tick_params(axis='x', labelsize=6)
    plt.legend()
    plt.savefig("./figures/QLR_Raw_Pt0_1__DCFxLambda")
    plt.clf()
    ...
    with open("./dati/datiQLR_Raw_Pt0_1.txt", "w") as fp:
        fp.write("dict1 :")
        fp.write(str(dict1))
        fp.write('\n')
        fp.write("minDCF: " + str(dict1[min(dict1, key=dict3.get)]))
...
#-------------------------------------------------------------#
        ...
        dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                                 applicationWorkingPoint1, costs, lambdValues)

        dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                                 applicationWorkingPoint2, costs, lambdValues)

        dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                                 applicationWorkingPoint3, costs, lambdValues)
        ...
        plt.tick_params(axis='x', labelsize=6)
        plt.legend()
        plt.savefig("./figures/QLR_Zscore_Pt0_5__DCFxLambda")
        plt.clf()
        ...
        with open("./dati/datiQLR_Zscore_Pt0_5.txt", "w") as fp:
            fp.write("dict1 :")
            fp.write(str(dict1))
            fp.write('\n')
            fp.write("minDCF: " + str(dict1[min(dict1, key=dict3.get)]))
        ...
        dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                                 applicationWorkingPoint1, costs, lambdValues)

        dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                                 applicationWorkingPoint2, costs, lambdValues)

        dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                                 applicationWorkingPoint3, costs, lambdValues)
        ...
        plt.tick_params(axis='x', labelsize=6)
        plt.legend()
        plt.savefig("./figures/QLR_Raw_Pt0_5__DCFxLambda")
        plt.clf()
        ...
        with open("./dati/datiQLR_Raw_Pt0_5.txt", "w") as fp:
            fp.write("dict1 :")
            fp.write(str(dict1))
            fp.write('\n')
            fp.write("minDCF: " + str(dict1[min(dict1, key=dict3.get)]))
...
#-------------------------------------------------------------#
        ...
        dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                                 applicationWorkingPoint1, costs, lambdValues)

        dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                                 applicationWorkingPoint2, costs, lambdValues)

        dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                                 applicationWorkingPoint3, costs, lambdValues)
        ...
        plt.tick_params(axis='x', labelsize=6)
        plt.legend()
        plt.savefig("./figures/QLR_Zscore_Pt0_9__DCFxLambda")
        plt.clf()
        ...
        with open("./dati/datiQLR_Zscore_Pt0_9.txt", "w") as fp:
            fp.write("dict1 :")
            fp.write(str(dict1))
            fp.write('\n')
            fp.write("minDCF: " + str(dict1[min(dict1, key=dict3.get)]))
        ...
        dict1 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                                 applicationWorkingPoint1, costs, lambdValues)

        dict2 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                                 applicationWorkingPoint2, costs, lambdValues)

        dict3 = classifiers.compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                                 applicationWorkingPoint3, costs, lambdValues)
        ...
        plt.tick_params(axis='x', labelsize=6)
        plt.legend()
        plt.savefig("./figures/QLR_Raw_Pt0_9__DCFxLambda")
        plt.clf()
        ...
        with open("./dati/datiQLR_Raw_Pt0_9.txt", "w") as fp:
            fp.write("dict1 :")
            fp.write(str(dict1))
            fp.write('\n')
            fp.write("minDCF: " + str(dict1[min(dict1, key=dict3.get)]))
