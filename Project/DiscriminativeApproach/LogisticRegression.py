...
if __name__ == "__main__":
    ...
    dict1 = functions.K_fold_cross_validation_DCF(DOriginalNormalized, L, "LR",
                                                  numFold, classPriorProbabilities1, costs, labels, lambdValues)

    dict2 = functions.K_fold_cross_validation_DCF(DOriginalNormalized, L, "LR",
                                                  numFold, classPriorProbabilities2, costs, labels, lambdValues)

    dict3 = functions.K_fold_cross_validation_DCF(DOriginalNormalized, L, "LR",
    ...
    dict1 = functions.K_fold_cross_validation_DCF(DOriginal, L, "LR",
                                                  numFold, classPriorProbabilities1, costs, labels, lambdValues)

    dict2 = functions.K_fold_cross_validation_DCF(DOriginal, L, "LR",
                                                  numFold, classPriorProbabilities2, costs, labels, lambdValues)

    dict3 = functions.K_fold_cross_validation_DCF(DOriginal, L, "LR",
                                                  numFold, classPriorProbabilities3, costs, labels, lambdValues)
