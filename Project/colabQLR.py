...
def compute_SVM_KFold_DCF(D, L, numFold, classPriorProbabilities, costs, CList, K):
    ...
    for i in range(numFold):
        (DTR, LTR), (DTE, LTE) = K_fold_generate_Training_and_Testing_samples(D, L, i, numFold, num_samples)
        for C in CList:
            print("numFold: " + str(i) + ", C: " + str(C))
            llr_SVM = compute_support_vector_machine_llr(DTR, LTR, DTE, LTE, K, C, classPriorProbabilities)
            for threshold in thresholds:
                optimalBayesDecisionPredictions = compute_optimal_bayes_decision_given_threshold(llr_SVM,
                                                                                                 threshold)
                confusionMatrix = compute_binary_confusion_matrix(optimalBayesDecisionPredictions, LTE)
                DCFsNormalized1.append(
                    compute_normalized_detection_cost_function(confusionMatrix, classPriorProbabilities,
                                                               costs))
            if C not in list(x.keys()):
                x[C] = min(DCFsNormalized1)
            else:
...
def compute_QLR_KFold_DCF(D, L, numFold, classPriorProbabilities, applicationWorkingPoint, costs, lambdaValues):
    ...
    for i in range(numFold):
        (DTR, LTR), (DTE, LTE) = K_fold_generate_Training_and_Testing_samples(D, L, i, numFold, num_samples)
        for lambd in lambdaValues:
            print("LR, numfold: " + str(i) + ", lambda: " + str(lambd))
            llr_LR = compute_logistic_regression_binary_llr(DTR, LTR, DTE, lambd, classPriorProbabilities)
            for threshold in thresholds:
                optimalBayesDecisionPredictions = compute_optimal_bayes_decision_given_threshold(llr_LR,
                                                                                                 threshold)
                confusionMatrix = compute_binary_confusion_matrix(optimalBayesDecisionPredictions, LTE)
                DCFsNormalized1.append(
                    compute_normalized_detection_cost_function(confusionMatrix, applicationWorkingPoint,
                                                               costs))
            if lambd not in list(x.keys()):
                x[lambd] = min(DCFsNormalized1)
            else:
...
def compute_QLR_KFold_DCF(D, L, numFold, classPriorProbabilities, applicationWorkingPoint, costs, lambdaValues):
    ...
    for i in range(numFold):
        ...
        DTE = quadratic_expansion(DTE)
        for lambd in lambdaValues:
            print("QLR, numfold: " + str(i) + ", lambda: " + str(lambd))
            llr_QLR = compute_logistic_regression_binary_quadratic_llr(DTR, LTR, DTE, lambd,
                                                                                 classPriorProbabilities)
            for threshold in thresholds:
                optimalBayesDecisionPredictions = compute_optimal_bayes_decision_given_threshold(llr_QLR,
                                                                                                           threshold)
                confusionMatrix = compute_binary_confusion_matrix(optimalBayesDecisionPredictions, LTE)
                DCFsNormalized1.append(
                    compute_normalized_detection_cost_function(confusionMatrix, applicationWorkingPoint,
...
if __name__ == "__main__":
    ...
    DTROriginalNormalized = (DTROriginal - compute_mean(DTROriginal)) / to_column(
        DTROriginal.std(axis=1))
    DTEOriginalNormalized = (DTEOriginal - compute_mean(DTEOriginal)) / to_column(
    ...
    print("Computing dict1")
    dict1 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
                                 applicationWorkingPoint1, costs, lambdValues)
    print("Computing dict2")
    dict2 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
                                 applicationWorkingPoint2, costs, lambdValues)
    print("Computing dict3")
    dict3 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
    ...
    print("Zscore, classPriorTrue: " + str(classPriorProbabilities1[1]))
    print("dict1: ", dict)
    ...
    print("Computing dict1")
    dict1 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                 applicationWorkingPoint1, costs, lambdValues)
    print("Computing dict2")
    dict2 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                 applicationWorkingPoint2, costs, lambdValues)
    print("Computing dict3")
    dict3 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                 applicationWorkingPoint3, costs, lambdValues)
    ...
    print("Raw, classPriorTrue: " + str(classPriorProbabilities1[1]))
    print("dict1: ", dict1)
    print("minDCF: ", dict1[min(dict1, key=dict1.get)])
    ...
    print("Computing dict1")
    dict1 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                 applicationWorkingPoint1, costs, lambdValues)
    print("Computing dict2")
    dict2 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                 applicationWorkingPoint2, costs, lambdValues)
    print("Computing dict3")
    dict3 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                 applicationWorkingPoint3, costs, lambdValues)
    ...
    print("Zscore, classPriorTrue: " + str(classPriorProbabilities2[1]))
    print("dict1: ", dict1)
    print("minDCF: ", dict1[min(dict1, key=dict1.get)])
    ...
    print("Computing dict1")
    dict1 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                 applicationWorkingPoint1, costs, lambdValues)
    print("Computing dict2")
    dict2 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                 applicationWorkingPoint2, costs, lambdValues)
    print("Computing dict3")
    dict3 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                 applicationWorkingPoint3, costs, lambdValues)
    ...
    print("Raw, classPriorTrue: " + str(classPriorProbabilities2[1]))
    print("dict1: ", dict1)
    print("minDCF: ", dict1[min(dict1, key=dict1.get)])
    ...
    print("Computing dict1")
    dict1 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                 applicationWorkingPoint1, costs, lambdValues)
    print("Computing dict2")
    dict2 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                 applicationWorkingPoint2, costs, lambdValues)
    print("Computing dict3")
    dict3 = compute_QLR_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                 applicationWorkingPoint3, costs, lambdValues)
    ...
    print("Zscore, classPriorTrue: " + str(classPriorProbabilities3[1]))
    print("dict1: ", dict1)
    print("minDCF: ", dict1[min(dict1, key=dict1.get)])
    ...
    print("Computing dict1")
    dict1 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                 applicationWorkingPoint1, costs, lambdValues)
    print("Computing dict1")
    dict2 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                 applicationWorkingPoint2, costs, lambdValues)
    print("Computing dict1")
    dict3 = compute_QLR_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                 applicationWorkingPoint3, costs, lambdValues)
    ...
    print("Raw, classPriorTrue: " + str(classPriorProbabilities3[1]))
    print("dict1: ", dict1)
    print("minDCF: ", dict1[min(dict1, key=dict1.get)])
