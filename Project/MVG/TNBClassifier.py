...
if __name__ == "__main__":
    ...
    kFoldDCFmin1 = classifiers.compute_TNB_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities1,
                                                     costs, labels)

    kFoldDCFmin2 = classifiers.compute_TNB_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities2,
                                                     costs, labels)

    kFoldDCFmin3 = classifiers.compute_TNB_KFold_DCF(DTROriginalNormalized, LTR, numFold, classPriorProbabilities3,
                                                     costs, labels)
    ...
    kFoldDCFmin1 = classifiers.compute_TNB_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities1,
                                                     costs, labels)

    kFoldDCFmin2 = classifiers.compute_TNB_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities2,
                                                     costs, labels)

    kFoldDCFmin3 = classifiers.compute_TNB_KFold_DCF(DTROriginal, LTR, numFold, classPriorProbabilities3,
                                                     costs, labels)
