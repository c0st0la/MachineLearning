...
if __name__ == "__main__":
    ...
    kFoldDCFmin1 = functions2.K_fold_cross_validation_DCF(DOriginalNormalized, L, "MVG",
                                               numFold, classPriorProbabilities1, costs, labels)
    kFoldDCFmin2 = functions2.K_fold_cross_validation_DCF(DOriginalNormalized, L, "MVG",
                                               numFold, classPriorProbabilities2, costs, labels)
    kFoldDCFmin3 = functions2.K_fold_cross_validation_DCF(DOriginalNormalized, L, "MVG",
    ...
    kFoldDCFmin1 = functions2.K_fold_cross_validation_DCF(DOriginal, L, "MVG",
                                                          numFold, classPriorProbabilities1, costs, labels)
    kFoldDCFmin2 = functions2.K_fold_cross_validation_DCF(DOriginal, L, "MVG",
                                                          numFold, classPriorProbabilities2, costs, labels)
    kFoldDCFmin3 = functions2.K_fold_cross_validation_DCF(DOriginal, L, "MVG",
                                                          numFold, classPriorProbabilities3, costs, labels)
