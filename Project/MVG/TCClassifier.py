...
if __name__ == "__main__":
    ...
    kFoldDCFmin1 = classifiers.compute_TC_KFold_DCF(DTROriginalNormalized, LTR, numFold, applicationWorkingPoint1,
                                                     costs, labels)

    kFoldDCFmin2 = classifiers.compute_TC_KFold_DCF(DTROriginalNormalized, LTR, numFold, applicationWorkingPoint2,
                                                     costs, labels)

    kFoldDCFmin3 = classifiers.compute_TC_KFold_DCF(DTROriginalNormalized, LTR, numFold, applicationWorkingPoint3,
                                                     costs, labels)
    ...
    kFoldDCFmin1 = classifiers.compute_TC_KFold_DCF(DTROriginal, LTR, numFold, applicationWorkingPoint1,
                                                     costs, labels)

    kFoldDCFmin2 = classifiers.compute_TC_KFold_DCF(DTROriginal, LTR, numFold, applicationWorkingPoint2,
                                                     costs, labels)

    kFoldDCFmin3 = classifiers.compute_TC_KFold_DCF(DTROriginal, LTR, numFold, applicationWorkingPoint3,
                                                     costs, labels)
