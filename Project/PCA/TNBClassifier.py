...
if __name__ == "__main__":
    ...
    for subDimensionPCA in range(8, DTROriginal.shape[0]+1):
        ...
        kFoldDCFmin1 = classifiers.compute_TNB_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold,
                                                         applicationWorkingPoint1,
                                                         costs, labels)

        kFoldDCFmin2 = classifiers.compute_TNB_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold,
                                                         applicationWorkingPoint2,
                                                         costs, labels)

        kFoldDCFmin3 = classifiers.compute_TNB_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold,
        ...
        with open("datiPCA/datiZScorePCATNB.txt", "a") as fp:
            fp.write(toPrint)
    ...
    for subDimensionPCA in range(8, DTROriginal.shape[0]+1):
        ...
        with open("datiPCA/datiRawPCATNB.txt", "a") as fp:
            fp.write(toPrint)
