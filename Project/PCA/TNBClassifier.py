...
if __name__ == "__main__":
    ...
    for subDimensionPCA in range(7, DTROriginal.shape[0]):
        ...
        llr_TNB = functions.compute_TNB_llrs(DTRNormalizedPCAOriginal, LTR, DTENormalizedPCAOriginal, labels)
        for threshold in thresholds:
            optimalBayesDecisionPredictions = functions.compute_optimal_bayes_decision_given_threshold(llr_TNB, threshold)
        ...
        kFoldDCFmin1 = classifiers.compute_TNB_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold, classPriorProbabilities1,
                                                         costs, labels)

        kFoldDCFmin2 = classifiers.compute_TNB_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold, classPriorProbabilities2,
                                                         costs, labels)

        kFoldDCFmin3 = classifiers.compute_TNB_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold, classPriorProbabilities3,
                                                         costs, labels)
        ...
        with open("datiPCA/datiZScorePCATNB.txt", "w") as fp:
            fp.write(toPrint)
        ...
        for subDimensionPCA in range(7, DTROriginal.shape[0]):
            ...
            llr_TNB = functions.compute_TNB_llrs(DTRPCAOriginal, LTR, DTEPCAOriginal, labels)
            for threshold in thresholds:
            ...
            kFoldDCFmin1 = classifiers.compute_TNB_KFold_DCF(DTRPCAOriginal, LTR, numFold,
                                                             classPriorProbabilities1, costs, labels)

            kFoldDCFmin2 = classifiers.compute_TNB_KFold_DCF(DTRPCAOriginal, LTR, numFold,
                                                             classPriorProbabilities2, costs, labels)

            kFoldDCFmin3 = classifiers.compute_TNB_KFold_DCF(DTRPCAOriginal, LTR, numFold,
                                                             classPriorProbabilities3, costs, labels)
            ...
            with open("datiPCA/datiRawPCATNB.txt", "w") as fp:
                fp.write(toPrint)
