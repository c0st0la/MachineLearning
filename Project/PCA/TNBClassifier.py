...
if __name__ == "__main__":
    ...
    for subDimensionPCA in range(7, DTROriginal.shape[0]):
        ...
        kFoldDCFmin1 = functions.K_fold_cross_validation_DCF(DOriginalPCANormalized, L, "TNB",
                                                   numFold, classPriorProbabilities1, costs, labels)
        kFoldDCFmin2 = functions.K_fold_cross_validation_DCF(DOriginalPCANormalized, L, "TNB",
                                                   numFold, classPriorProbabilities2, costs, labels)
        kFoldDCFmin3 = functions.K_fold_cross_validation_DCF(DOriginalPCANormalized, L, "TNB",
        ...
        for subDimensionPCA in range(7, DTROriginal.shape[0]):
            ...
            kFoldDCFmin1 = functions.K_fold_cross_validation_DCF(DPCAriginal, L, "TNB",
                                                                 numFold, classPriorProbabilities1, costs, labels)
            kFoldDCFmin2 = functions.K_fold_cross_validation_DCF(DPCAriginal, L, "TNB",
                                                                 numFold, classPriorProbabilities2, costs, labels)
            kFoldDCFmin3 = functions.K_fold_cross_validation_DCF(DPCAriginal, L, "TNB",
                                                                 numFold, classPriorProbabilities3, costs, labels)
