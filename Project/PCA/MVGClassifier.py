...
if __name__ == "__main__":
    ...
    for subDimensionPCA in range(7, DTROriginal.shape[0]):
        ...
        kFoldDCFmin1 = classifiers.compute_MVG_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold, applicationWorkingPoint1,
                                                         costs, labels)

        kFoldDCFmin2 = classifiers.compute_MVG_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold, applicationWorkingPoint2,
                                                         costs, labels)

        kFoldDCFmin3 = classifiers.compute_MVG_KFold_DCF(DTRNormalizedPCAOriginal, LTR, numFold, applicationWorkingPoint3,
                                                         costs, labels)
