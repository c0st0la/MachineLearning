...
if __name__ == "__main__":
    ...
    for subDimensionPCA in range(7, DTROriginal.shape[0]):
        ...
        kFoldDCFmin1 = functions.K_fold_cross_validation_DCF(DOriginalPCANormalized, L, "TC",
                                                   numFold, classPriorProbabilities1, costs, labels)
        kFoldDCFmin2 = functions.K_fold_cross_validation_DCF(DOriginalPCANormalized, L, "TC",
                                                   numFold, classPriorProbabilities2, costs, labels)
        kFoldDCFmin3 = functions.K_fold_cross_validation_DCF(DOriginalPCANormalized, L, "TC",
        ...
        for subDimensionPCA in range(7, DTROriginal.shape[0]):
            ...
            kFoldDCFmin1 = functions.K_fold_cross_validation_DCF(DPCAriginal, L, "TC",
                                                                 numFold, classPriorProbabilities1, costs, labels)
            kFoldDCFmin2 = functions.K_fold_cross_validation_DCF(DPCAriginal, L, "TC",
                                                                 numFold, classPriorProbabilities2, costs, labels)
            kFoldDCFmin3 = functions.K_fold_cross_validation_DCF(DPCAriginal, L, "TC",
                                                                 numFold, classPriorProbabilities3, costs, labels)
